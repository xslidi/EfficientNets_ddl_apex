...
class DALIDataloader(DALIGenericIterator):
    def __init__(self, pipeline, size, batch_size, output_map=["data", "label"], auto_reset=True, onehot_label=False, world_size=1):
        self.size_1 = size
    ...
    def __len__(self):
        if self.size_1%self.batch_size==0:
            return self.size_1//self.batch_size
        else:
            return self.size_1//self.batch_size+1
